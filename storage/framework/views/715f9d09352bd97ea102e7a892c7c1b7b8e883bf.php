                                                            ...
                                                            <div class="col-md-12 mb-3">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-8 mx-auto">
                                                                        <img class="img"
                                                                            src="<?php echo e(asset('img/data-marketing/cs1.png')); ?>"
                                                                            width="100%"> <br> <br>
                                                                        <img class="img"
                                                                            src="<?php echo e(asset('img/data-marketing/cs2.png')); ?>"
                                                                            width="100%"> <br> <br>
                                                                        <img class="img"
                                                                            src="<?php echo e(asset('img/data-marketing/cs3.png')); ?>"
                                                                            width="100%"> <br><br>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="row align-items-center">
                                                            <div class="col-md-12 mb-3">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-8 mx-auto">
                                                                        <img class="img"
                                                                            src="<?php echo e(asset('img/data-marketing/cs5.png')); ?>"
                                                                            width="100%">
                                                                    </div>
                                                                </div>
                                                                <br>
                            ...
                            <div class="accordion-body">
                                <div class="row align-items-center">
                                    <div class="col-md-12 mb-3 pc">
                                        ...
                                        <iframe width="100%" height="315" src="https://www.youtube.com/embed/YsxA_C80-Cc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe><br>
                                        <div class="accordion my-2" id="accordionPanelsStayOpenExample">
                                                ...
                                                <div id="cs2-2" class="accordion-collapse collapse"
                                                    ...
                                                    <div class="accordion-body">
                                                        <div class="row align-items-center">
                                                            <div class="col-md-12 mb-3">
                                                                <img class="img"
                                                                    src="<?php echo e(asset('img/data-marketing/cs6.png')); ?>"
                                                                    width="100%">

                                                                <div class="text-center">
                                                                    <a href="<?php echo e(asset('file/digital-marketing/CS2 - Customer Journey.xlsx')); ?>"
                                                                        class="btn btn-primary btn-sm px-3">Download the
                                                                        Worksheet</a>
                                                                </div>
                                                                </p>
                                                    ...
                                                    <div class="accordion-body">
                                                        <div class="row align-items-center">
                                                            <div class="col-md-12 mb-3">
                                                                ...
                                                                <img class="img"
                                                                    src="<?php echo e(asset('img/data-marketing/cs7.png')); ?>"
                                                                    width="100%">
...
<?php echo $__env->make('layout.module.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u5332263/public_html/others/github/career-module/resources/views/modules/digital-marketing/part-5.blade.php ENDPATH**/ ?>